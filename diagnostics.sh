...
sudo bash agent/gather_agent_info.sh | sudo tee /opt/threatstack/cloudsight/logs/agent_info.txt
sudo bash agent/gather_fim_info.sh | sudo tee /opt/threatstack/cloudsight/logs/fim_info.txt
